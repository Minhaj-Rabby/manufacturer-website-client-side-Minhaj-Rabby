...
const Summery = () => {
	...
	useEffect(() => {
		fetch(`${SERVERURL}/totalcoustomer`)
			.then((res) => res.json())
			.then((data) => setCustomer(data));
		fetch(`${SERVERURL}/totalreview`)
			.then((res) => res.json())
			.then((data) => setReview(data));
		fetch(`${SERVERURL}/totalproduct`)
			.then((res) => res.json())
	...
	return (
		<div className="container mx-auto py-8 px-2">
			<h1 className="text-3xl font-bold my-6 text-center">Business summary</h1>
